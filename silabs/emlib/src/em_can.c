...
void CAN_Reset(CAN_TypeDef *can)
{
  ...
  can->MSGIFS = _CAN_MSGIFS_RESETVALUE;
  can->MSGIFC = _CAN_MSGIFC_RESETVALUE;
  can->MSGIEN = _CAN_MSGIEN_RESETVALUE;
  can->STATUSIFS = _CAN_STATUSIF_RESETVALUE;
  can->STATUSIFC = _CAN_STATUSIFC_RESETVALUE;
  can->STATUSIEN = _CAN_STATUSIEN_RESETVALUE;
