...
{
    MQTT_RETURN_CODE_ACCEPTED   = 0,
    MQTT_RETURN_CODE_UNACCEPTED_CONTROL_VERSION   = 1,
    MQTT_RETURN_CODE_IDENTIFIER_REJECTED   = 2,
    MQTT_RETURN_CODE_SERVER_BUSY   = 3,
    MQTT_RETURN_CODE_BAD_USERNAME_PASSWORD   = 4,
    MQTT_RETURN_CODE_UNAUTHORIZED_ACCESS   = 5,
}mqtt_return_code_t;
...
typedef struct mqtt_suback_arg_s
{
    uint16_t                    packet_id;
    mqtt_return_code_t          return_code;
} mqtt_suback_arg_t;
