...
#define ARDUCAM_SPECIALEFFECT_NONE        0
#define ARDUCAM_SPECIALEFFECT_NEGATIVE    1
#define ARDUCAM_SPECIALEFFECT_GRAY        2
#define ARDUCAM_SPECIALEFFECT_SEPIA       3
#define ARDUCAM_SPECIALEFFECT_BLUISH      4
#define ARDUCAM_SPECIALEFFECT_REDDISH     5
#define ARDUCAM_SPECIALEFFECT_GREENISH    6
#define ARDUCAM_SPECIALEFFECT_ANTIQUE     7
#define ARDUCAM_SPECIALEFFECT_COUNT       8
