...
/**
 * Initialise capacitativebutton driver.
 *
...
/**
 * Poll inputbutton to see if new data is available
 *
 ...
 * @return @ref zos_result_t
 */
zos_result_t sensor_capacitativebuttons_read(uint16_t *raw_data);
 ...
 * @return @ref zos_result_t
 */
float sensor_capacitativebuttons_convert(uint16_t raw_value);
